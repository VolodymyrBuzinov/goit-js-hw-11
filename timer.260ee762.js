...
var CountdownTimer = /*#__PURE__*/function () {
  ...
  _createClass(CountdownTimer, [{
    key: "countDate",
    value: function countDate() {
      var time = new Date(this.date) - Date.now();
    ...
    value: function run() {
      ...
      var deadline = Date.parse(this.date) <= Date.parse(new Date());
...
var endingDate = timer.date.toLocaleString('ru', {
  year: 'numeric',
  month: 'long',
  day: 'numeric'
});
